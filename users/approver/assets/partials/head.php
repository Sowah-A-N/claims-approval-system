...
<head>
  ...
  <meta name="description" content="Claim approvals for the RMU Claims Approval System.">
  <title><?php echo (isset($pageTitle) && $pageTitle !== '') ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') . ' · RMU Approver' : 'RMU Approver'; ?></title>

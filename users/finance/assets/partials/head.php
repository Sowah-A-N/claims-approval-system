...
<head>
  ...
  <meta name="description" content="Finance workspace for the RMU Claims Approval System.">
  <title><?php echo (isset($pageTitle) && $pageTitle !== '') ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') . ' · RMU Finance' : 'RMU Finance'; ?></title>
  <link rel="shortcut icon" type="image/png" href="<?php echo ($pageTitle === 'Finance Dashboard') ? 'assets/images/logos/favicon.png' : '../../assets/images/logos/favicon.png'; ?>">
  ...
  <?php $rmu_css = ($pageTitle === 'Finance Dashboard') ? '../../assets/css/rmu-glass.css?v=7' : '../../../../assets/css/rmu-glass.css?v=7'; ?>
  ...
  <!-- SweetAlert2 for confirmations (flag/mark-paid feedback) -->

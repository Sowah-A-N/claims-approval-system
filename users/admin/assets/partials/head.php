...
<head>
  ...
  <meta name="description" content="Administration console for the RMU Claims Approval System.">
  <title><?php echo (isset($pageTitle) && $pageTitle !== '') ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') . ' · RMU Admin' : 'RMU Admin'; ?></title>
  <link rel="shortcut icon" type="image/png" href="<?php echo ($pageTitle === 'Admin Dashboard') ? 'assets/images/logos/favicon.png' : '../../assets/images/logos/favicon.png'; ?>">
  ...
  <?php $rmu_css = ($pageTitle === 'Admin Dashboard') ? '../../assets/css/rmu-glass.css?v=7' : '../../../../assets/css/rmu-glass.css?v=7'; ?>

            ...
            <?php endif; ?>
                ...
                <form method="POST" action="">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="bank_name" class="form-control form-select" id="bank_name" style="width:70%">
                            <?php
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="branch_name" class="form-control form-select" id="branch_name" style="width:70%">
                                <?php

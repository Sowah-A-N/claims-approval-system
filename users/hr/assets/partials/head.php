...
<head>
  ...
  <meta name="description" content="HR employee management for the RMU Claims Approval System.">
  <title><?php echo (isset($pageTitle) && $pageTitle !== '') ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') . ' · RMU HR' : 'RMU HR'; ?></title>
  ...
  <?php $rmu_css = ($pageTitle === 'HR Dashboard') ? '../../assets/css/rmu-glass.css?v=6' : '../../../../assets/css/rmu-glass.css?v=6'; ?>
